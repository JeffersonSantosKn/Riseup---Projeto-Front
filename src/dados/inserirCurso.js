import { cursosPlaylistsFormatados } from './cursosPlaylistsFormatados'

//exemplo ABAIXO
const cursosInseridosBase = [
...
{
  id: 'curso-csharp-dotnet-iniciantes',
  titulo: 'Curso de C# e .NET para Iniciantes',
  categoria: 'Back-end',
  tecnologia: 'csharp',
  nivel: 'Basico',
  duracao: '3h57',
  professor: 'Fredi',
  videoPrincipal: 'https://www.youtube.com/watch?v=oTivhgjbhIg',
  tags: 'csharp, dotnet, backend, programacao, poo, api-rest, microsoft, visual-studio-code',
  trilhas: 'backend-api-base,api-http-rest',
  descricao:
    'Aprenda os fundamentos de C# e .NET, criando os primeiros projetos, entendendo sintaxe, orientacao a objetos, estrutura da plataforma e preparacao para evoluir em APIs com ASP.NET Core.',
  destaque: 'Base ideal para comecar em C# e seguir para APIs .NET.',
  modulos: [
    {
      titulo: 'Modulo 1: Introducao ao C# e .NET',
      descricao: 'Entenda o que e C#, o que e .NET e prepare o ambiente para criar seus primeiros programas.',
      aulas: [
        {
          titulo: 'Curso de C# / .NET para Iniciantes',
          duracao: '3h57',
          link: 'https://www.youtube.com/watch?v=oTivhgjbhIg',
          descricao: 'Curso introdutorio de C# e .NET para quem quer comecar no ecossistema Microsoft.',
          capitulos: [
            { inicio: '0:00:00', titulo: 'Intro (Importante)' },
            { inicio: '0:01:42', titulo: 'SDK .NET 6' },
            { inicio: '0:03:42', titulo: 'Extensoes VS Code necessarias' },
            { inicio: '0:05:21', titulo: 'Comandos dotnet' },
            { inicio: '0:08:51', titulo: 'Arquivo csproj' },
            { inicio: '0:09:24', titulo: 'Linguagem' },
            { inicio: '0:12:49', titulo: 'Tipos e objetos' },
            { inicio: '0:16:48', titulo: 'Variaveis' },
            { inicio: '0:18:47', titulo: 'Instrucoes e expressoes' },
            { inicio: '0:21:35', titulo: 'Expression statements' },
            { inicio: '0:23:35', titulo: 'Operadores e operandos' },
            { inicio: '0:25:45', titulo: 'Tipagem estatica' },
            { inicio: '0:27:28', titulo: 'Classe Console e namespace System' },
            { inicio: '0:29:12', titulo: 'Classes estaticas' },
            { inicio: '0:29:46', titulo: 'Membros de instancia' },
            { inicio: '0:31:54', titulo: 'Primeiro programa' },
            { inicio: '0:35:16', titulo: 'Concatenacao e interpolacao de strings' },
            { inicio: '0:36:34', titulo: 'Nullables em projetos' },
            { inicio: '0:37:02', titulo: 'Solicitando dados do usuario' },
            { inicio: '0:37:46', titulo: 'Converter string para inteiro' },
            { inicio: '0:40:30', titulo: 'Desvio condicional com if' },
            { inicio: '0:41:01', titulo: 'Expressoes booleanas' },
            { inicio: '0:42:35', titulo: 'else e else if' },
            { inicio: '0:46:02', titulo: 'Operadores logicos' },
            { inicio: '0:47:04', titulo: 'Arrays' },
            { inicio: '0:51:06', titulo: 'Top level statements' },
            { inicio: '0:52:12', titulo: 'Classe Program e metodo Main' },
            { inicio: '0:55:20', titulo: 'Tipo de retorno void' },
            { inicio: '0:56:50', titulo: 'Acessando elementos de arrays' },
            { inicio: '0:57:32', titulo: 'Loop for' },
            { inicio: '0:59:16', titulo: 'Breakpoint e Debug' },
            { inicio: '1:03:50', titulo: 'Loop foreach' },
            { inicio: '1:05:56', titulo: 'Case-sensitive' },
            { inicio: '1:08:36', titulo: 'Comparar strings ignorando maiusculas e minusculas' },
            { inicio: '1:09:46', titulo: 'Operacoes com strings' },
            { inicio: '1:17:14', titulo: 'Operacoes com numeros' },
            { inicio: '1:20:56', titulo: 'Conversoes implicitas e explicitas' },
            { inicio: '1:24:16', titulo: 'Convertendo para string com ToString()' },
            { inicio: '1:24:48', titulo: 'Tipos de referencia e tipos de valor' },
            { inicio: '1:30:43', titulo: 'Igualdade de valores e referencias' },
            { inicio: '1:31:40', titulo: 'Tipos anulaveis' },
            { inicio: '1:36:06', titulo: 'Tipos de referencia anulaveis' },
            { inicio: '1:38:41', titulo: 'Tratamento de excecao' },
            { inicio: '1:44:59', titulo: 'Classes e campos' },
            { inicio: '1:48:03', titulo: 'Acessibilidade de membros e encapsulamento' },
            { inicio: '1:49:22', titulo: 'Construtores' },
            { inicio: '1:51:56', titulo: 'Validando dados no construtor' },
            { inicio: '1:52:26', titulo: 'Lancando uma excecao' },
            { inicio: '1:54:01', titulo: 'Parametros vs argumentos' },
            { inicio: '1:55:07', titulo: 'Operador nameof' },
            { inicio: '1:57:12', titulo: 'Criando um metodo' },
            { inicio: '1:58:27', titulo: 'Expressao de atribuicao composta' },
            { inicio: '2:00:00', titulo: 'Executando metodo' },
            { inicio: '2:00:36', titulo: 'Step Into (Debug)' },
            { inicio: '2:02:13', titulo: 'Criando metodo que retorna um objeto' },
            { inicio: '2:03:49', titulo: 'Propriedades' },
            { inicio: '2:07:21', titulo: 'Validando dados no set' },
            { inicio: '2:09:16', titulo: 'Interfaces' },
            { inicio: '2:13:48', titulo: 'Modificador readonly' },
            { inicio: '2:16:32', titulo: 'Escrevendo e salvando em arquivo' },
            { inicio: '2:22:09', titulo: 'Generics' },
            { inicio: '2:24:09', titulo: 'Inicializador de colecoes com Listas' },
            { inicio: '2:26:16', titulo: 'Criando um tipo generico' },
            { inicio: '2:28:14', titulo: 'Tipagem forte com generics' },
            { inicio: '2:29:27', titulo: 'Declaracao de variaveis com tipo implicito' },
            { inicio: '2:30:56', titulo: 'Delegate' },
            { inicio: '2:34:51', titulo: 'Passando delegate como argumento' },
            { inicio: '2:35:33', titulo: 'Metodos anonimos' },
            { inicio: '2:36:41', titulo: 'Func e Action' },
            { inicio: '2:39:44', titulo: 'Sufixo de tipos numericos' },
            { inicio: '2:41:28', titulo: 'Expressoes Lambda' },
            { inicio: '2:44:45', titulo: 'Metodos de extensao' },
            { inicio: '2:51:54', titulo: 'Declarando namespace' },
            { inicio: '2:53:38', titulo: 'Implicit usings' },
            { inicio: '2:54:52', titulo: 'Importando namespace com using' },
            { inicio: '2:56:56', titulo: 'Serializacao e deserializacao JSON' },
            { inicio: '3:02:17', titulo: 'Multiplos construtores' },
            { inicio: '3:04:12', titulo: 'Attributes' },
            { inicio: '3:06:40', titulo: 'LINQ' },
            { inicio: '3:07:25', titulo: 'Query Syntax' },
            { inicio: '3:08:46', titulo: 'Execucao adiada' },
            { inicio: '3:09:19', titulo: 'Method Syntax' },
            { inicio: '3:12:16', titulo: 'Explorando a classe Enumerable' },
            { inicio: '3:14:01', titulo: 'Atencao com execucao adiada' },
            { inicio: '3:16:35', titulo: 'Materializando uma consulta LINQ' },
            { inicio: '3:18:14', titulo: 'First e FirstOrDefault' },
            { inicio: '3:21:07', titulo: 'OrderBy e OrderByDescending' },
            { inicio: '3:23:51', titulo: 'GroupBy' },
            { inicio: '3:28:06', titulo: 'Select' },
            { inicio: '3:31:40', titulo: 'Tipos anonimos' },
            { inicio: '3:33:09', titulo: 'Enumerable.Empty e Enumerable.Range' },
            { inicio: '3:37:45', titulo: 'Usando Range para retornar letras do alfabeto' },
            { inicio: '3:39:23', titulo: 'Programacao assincrona' },
            { inicio: '3:41:44', titulo: 'Operacao sincrona e assincrona' },
            { inicio: '3:43:56', titulo: 'Executando codigo de forma assincrona' },
            { inicio: '3:47:24', titulo: 'async e await' },
            { inicio: '3:50:12', titulo: 'Retornando objeto em uma Task' },
            { inicio: '3:52:27', titulo: 'Gerando o executavel da aplicacao' },
            { inicio: '3:53:35', titulo: 'Executando em outro computador com o Runtime' },
            { inicio: '3:55:18', titulo: 'Proximos passos (Importante)' },
          ],
        },
      ],
    },
...
{
  id: 'curso-dotnet-api-crud',
  titulo: 'CRUD API com C# e .NET 8',
  categoria: 'Back-end',
  tecnologia: 'csharp',
  nivel: 'Intermediario',
  duracao: '1h06',
  professor: 'Professor externo',
  videoPrincipal: 'https://www.youtube.com/watch?v=UXMKOgmQ7zI',
  tags: 'csharp, dotnet, dotnet8, minimal-api, api-rest, crud, backend, microsoft',
  trilhas: 'backend-api-base,api-http-rest',
  descricao:
    'Construa uma API CRUD com C# e .NET 8, praticando rotas, endpoints, estrutura de projeto, Minimal APIs e conceitos essenciais de desenvolvimento back-end.',
  destaque: 'Crie sua primeira API REST com C# e .NET 8.',
  modulos: [
    {
      titulo: 'Modulo 1: API CRUD com .NET 8',
      descricao: 'Construa uma API do zero usando C#, .NET 8 e Minimal APIs.',
      aulas: [
        {
          titulo: 'Complete CRUD API with C# and .NET 8 from Scratch',
          duracao: '1h06',
          link: 'https://www.youtube.com/watch?v=UXMKOgmQ7zI',
          descricao: 'Projeto pratico de API CRUD usando C# e .NET 8.',
          capitulos: [
            { inicio: '2:10', titulo: 'Inicio do projeto e configuracao inicial' },
            { inicio: '3:16', titulo: 'Criacao da Web API com .NET 8 e Minimal APIs' },
            { inicio: '12:04', titulo: 'Organizacao de rotas com classes estaticas' },
            { inicio: '17:31', titulo: 'Criacao do modelo de dados (PersonModel)' },
            { inicio: '25:14', titulo: 'Configuracao do Entity Framework e SQLite' },
            { inicio: '34:07', titulo: 'Criacao da primeira migracao' },
            { inicio: '40:05', titulo: 'Implementacao do verbo POST' },
            { inicio: '48:08', titulo: 'Implementacao do verbo GET' },
            { inicio: '52:19', titulo: 'Implementacao do verbo PUT' },
            { inicio: '1:00:04', titulo: 'Implementacao do verbo DELETE (Soft Delete)' },
            { inicio: '1:06:14', titulo: 'Conclusao e encerramento' },
          ],
        },
      ],
    },
...

{
  ...
  duracao: 'A confirmar',
  professor: 'Professor externo',
  videoPrincipal: 'https://www.youtube.com/playlist?list=PLtOMJw0mwbp1hfhMbw0uv29QZFdElmXAt',
  tags: 'nextjs, react, frontend, fullstack, ssr, roteamento, typescript, web',
  trilhas: 'react-frontend,backend-api-base',
  descricao:
    'Aprenda os fundamentos do Next.js 14 para criar aplicacoes React mais robustas, com roteamento, renderizacao, organizacao de projeto e recursos modernos do ecossistema front-end.',
  destaque: 'Evolua de React para aplicacoes profissionais com Next.js.',
  modulos: [
    {
      titulo: 'Modulo 1: Fundamentos do Next.js',
      descricao: 'Entenda renderizacao, estrutura do projeto e primeiros recursos do Next.js.',
      aulas: [
        {
          titulo: 'NextJS 14 Curso completo: Aula 01 - Renderizacao',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/playlist?list=PLtOMJw0mwbp1hfhMbw0uv29QZFdElmXAt',
          descricao: 'Introducao aos modelos de renderizacao no Next.js.',
        },
        {
          titulo: 'NextJS 14 Curso completo: Aula 02 - Criando primeiro projeto',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/playlist?list=PLtOMJw0mwbp1hfhMbw0uv29QZFdElmXAt',
          descricao: 'Criacao e configuracao inicial do projeto Next.js.',
        },
        {
          titulo: 'NextJS 14 Curso completo: Aula 03 - Roteamento',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/playlist?list=PLtOMJw0mwbp1hfhMbw0uv29QZFdElmXAt',
          descricao: 'Primeiros passos com rotas e navegacao no Next.js.',
        },
      ],
    },
  ],
...

{
  ...
  nivel: 'Basico',
  duracao: '4h',
  professor: 'Boson Treinamentos',
  videoPrincipal: 'https://www.youtube.com/playlist?list=PLucm8g_ezqNoAkYKXN_zWupyH6hQCAwxY',
  tags: 'postgresql, sql, banco-de-dados, dados, backend, consultas, relacional',
  trilhas: 'sql-banco-dados,dados-python-sql-profissional,backend-api-base,backend-java-profissional,backend-node-api-profissional',
  descricao:
    'Aprenda PostgreSQL do basico, entendendo instalacao, criacao de bancos, tabelas, consultas SQL e recursos importantes para aplicacoes back-end e analise de dados.',
  destaque: 'Aprofunde SQL com PostgreSQL, um dos bancos mais usados no mercado.',
  modulos: [
    {
      titulo: 'Modulo 1: Fundamentos de PostgreSQL',
      descricao: 'Introducao ao PostgreSQL, criacao de banco e primeiros comandos SQL.',
      aulas: [
        {
          titulo: 'Curso de PostgreSQL - Bancos de Dados',
          duracao: '4h',
          link: 'https://www.youtube.com/playlist?list=PLucm8g_ezqNoAkYKXN_zWupyH6hQCAwxY',
          descricao: 'Curso completo de PostgreSQL com aulas sequenciais para desenvolvedores.',
        },
      ],
    },
  ],
...
{
  id: 'curso-fastapi-python',
  titulo: 'FastAPI com Python - APIs Modernas',
  categoria: 'Back-end',
  tecnologia: 'fastapi',
  nivel: 'Intermediario',
  duracao: 'A confirmar',
  professor: 'Eduardo Mendes',
  videoPrincipal: 'https://www.youtube.com/playlist?list=PLOQgLBuj2-3KT9ZWvPmaGFQ0KjIez0403',
  tags: 'python, fastapi, api-rest, backend, pydantic, sqlalchemy, crud, web',
  trilhas: 'python-dados,dados-python-sql-profissional,backend-api-base,api-http-rest',
  descricao:
    'Aprenda a construir APIs modernas com Python e FastAPI, passando por fundamentos web, rotas, validacao de dados, organizacao de projeto e praticas usadas em aplicacoes reais.',
  destaque: 'Crie APIs modernas com Python usando FastAPI.',
  modulos: [
    {
      titulo: 'Modulo 1: Introducao ao FastAPI',
      descricao: 'Entenda o objetivo do curso, as ferramentas utilizadas e os primeiros conceitos de desenvolvimento web.',
      aulas: [
        {
          titulo: 'Curso de FastAPI 2025 - Aula de abertura',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/watch?v=ImhYlISeWPQ',
          descricao: 'Apresentacao do curso, tecnologias utilizadas e projeto final.',
        },
        {
          titulo: 'Curso de FastAPI 2025 - Fundamentos do desenvolvimento web',
          duracao: '1h52',
          link: 'https://www.youtube.com/watch?v=JFJErxis_ZM',
          descricao: 'Fundamentos de web, HTTP e comunicacao entre cliente e servidor.',
        },
        {
          titulo: 'Curso de FastAPI - Criando Rotas CRUD 2025',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/playlist?list=PLOQgLBuj2-3KT9ZWvPmaGFQ0KjIez0403',
          descricao: 'Criacao de rotas e operacoes CRUD com FastAPI.',
        },
      ],
    },
  ],
...
{
  id: 'curso-power-bi-basico',
  titulo: 'Power BI Basico - Primeiro Dashboard',
  categoria: 'Dados',
  tecnologia: 'power-bi',
  nivel: 'Basico',
  duracao: 'A confirmar',
  professor: 'Hashtag Treinamentos',
  videoPrincipal: 'https://www.youtube.com/watch?v=VMSfIaiW54M',
  tags: 'power-bi, dados, dashboard, business-intelligence, power-query, visualizacao-de-dados',
  trilhas: 'dados-base-primeira-vaga,dados-python-sql-profissional,python-dados',
  descricao:
    'Aprenda os primeiros passos no Power BI, entendendo o ambiente da ferramenta, importacao de bases, tratamento de dados e criacao de dashboards para analise visual.',
  destaque: 'Transforme dados em dashboards profissionais com Power BI.',
  modulos: [
    {
      titulo: 'Modulo 1: Introducao ao Power BI',
      descricao: 'Instale o Power BI, conheca o ambiente e prepare a primeira base de dados.',
      aulas: [
        {
          titulo: 'Curso Basico de Power BI - Aula 1 - Introducao ao Power BI',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/watch?v=VMSfIaiW54M',
          descricao: 'Introducao ao Power BI, instalacao, ambiente e tratamento inicial de dados.',
        },
      ],
    },
  ],
...
{
  id: 'curso-playwright-basico',
  titulo: 'Playwright Basico para Automacao de Testes',
  categoria: 'QA',
  tecnologia: 'playwright',
  nivel: 'Basico',
  duracao: 'A confirmar',
  professor: 'Marcos Franco - Start QA',
  videoPrincipal: 'https://www.youtube.com/playlist?list=PLu6sLyecW1TjbX7mSfnoORw9G3RJPCrVs',
  tags: 'qa, playwright, automacao, testes-e2e, testes-web, javascript, typescript',
  trilhas: 'qa-testes,qa-automacao-profissional,react-frontend',
  descricao:
    'Aprenda os fundamentos do Playwright para automacao de testes web, criando testes end-to-end e validando aplicacoes em diferentes cenarios.',
  destaque: 'Automatize testes web modernos com Playwright.',
  modulos: [
    {
      titulo: 'Modulo 1: Introducao ao Playwright',
      descricao: 'Primeiros passos com Playwright, estrutura de testes e automacao basica.',
      aulas: [
        {
          titulo: 'Curso basico de Playwright',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/playlist?list=PLu6sLyecW1TjbX7mSfnoORw9G3RJPCrVs',
          descricao: 'Playlist introdutoria de automacao de testes com Playwright.',
        },
      ],
    },
  ],
...
{
  id: 'curso-tailwind-css-basico',
  titulo: 'Tailwind CSS para Interfaces Modernas',
  categoria: 'Front-end',
  tecnologia: 'tailwind',
  nivel: 'Basico',
  duracao: 'A confirmar',
  professor: 'Matheus Battisti / Hora de Codar',
  videoPrincipal: 'https://www.youtube.com/watch?v=16SgbNGxWfY',
  tags: 'tailwind, css, frontend, interfaces, responsividade, design-system',
  trilhas: 'javascript-frontend,react-frontend,frontend-base-portfolio',
  descricao:
    'Aprenda a usar Tailwind CSS para criar interfaces modernas, responsivas e produtivas, aplicando classes utilitarias no desenvolvimento front-end.',
  destaque: 'Crie interfaces modernas com Tailwind CSS.',
  modulos: [
    {
      titulo: 'Modulo 1: Introducao ao Tailwind CSS',
      descricao: 'Conheca Tailwind CSS, classes utilitarias e primeiros passos para estilizar interfaces.',
      aulas: [
        {
          titulo: 'Curso de Tailwind CSS do Basico ao Avancado',
          duracao: 'A confirmar',
          link: 'https://www.youtube.com/watch?v=16SgbNGxWfY',
          descricao: 'Introducao ao Tailwind CSS e sua aplicacao em projetos front-end.',
        },
      ],
    },
  ],
...
const idsSubstituidosPorPlaylists = new Set([
  ...cursosPlaylistsFormatados.map((curso) => curso.id),
  'curso-playwright-basico',
])

export const inserirCurso = [
  ...cursosInseridosBase.filter((curso) => !idsSubstituidosPorPlaylists.has(curso.id)),
  ...cursosPlaylistsFormatados,
]
